...
obsidian_organizer_runs = sa.Table(
    ...
    sa.Column("error_code", sa.String(128), nullable=True),
    sa.Column("knowledge_status", sa.String(40), nullable=False),
    ...
    sa.Column("knowledge_attempt_count", sa.Integer(), nullable=False),
...
knowledge_source_records = sa.Table(
...
knowledge_source_payloads = sa.Table(
...
atomic_knowledge_candidates = sa.Table(
...
knowledge_change_proposals = sa.Table(
...
personalized_training_materials = sa.Table(
    ...
    sa.Column("quality_reports", postgresql.JSONB(), nullable=False),
    sa.Column("objective_bundle", postgresql.JSONB(), nullable=False),
    sa.Column("question_bank", postgresql.JSONB(), nullable=False),
    sa.Column("grammar_annotations", postgresql.JSONB(), nullable=False),
...
reading_evidence_snapshots = sa.Table(
